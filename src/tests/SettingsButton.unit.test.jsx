...
describe("Test SettingsButton", () => {
  const initialState1 = defaultInitialState;
  const initialState2 = {
    preloadedState: {
      main: {
        ...defaultInitialState.preloadedState.main,
        fromLang: Lang.ru,
        sortVerbs: true,
      },
    },
